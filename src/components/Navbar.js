    ...
    return (
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content flex flex-col">
                ...
                <div className="w-full navbar fixed top-0 z-50 lg:px-10">
                    <div className="flex-1 px-2 mx-1 font-bold text-3xl">Clean Co.</div>
                    ...
                    <div className="flex-none hidden lg:block">
                        <ul className="menu menu-horizontal gap-x-2">
                            {/*      If I use a NavLink instead of a  link, it will show the page I am on as the active link. */}
